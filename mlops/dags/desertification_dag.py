...
"""
Airflow DAG for the desertification project.

Schedule: Quarterly
Cron: 0 6 1 1,4,7,10 *
AOIs: qassim-agri-edge
...
MODEL_NAME = "desertification-model"
...
with DAG(
    "desertification_pipeline",
    default_args=default_args,
    schedule_interval="0 6 1 1,4,7,10 *",
    start_date=datetime(2024, 1, 1),
    catchup=False,
    tags=["saudi-sentinel", "desertification"],
) as dag:
