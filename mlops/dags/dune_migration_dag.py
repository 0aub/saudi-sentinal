...
"""
Airflow DAG for the dune-migration project.

Schedule: Quarterly SAR composite
Cron: 0 6 1 1,4,7,10 *
AOIs: rub-al-khali-north
...
PROJECT = "dune-migration"
MODEL_NAME = "dune-migration-model"
...
with DAG(
    "dune_migration_pipeline",
    default_args=default_args,
    schedule_interval="0 6 1 1,4,7,10 *",
    start_date=datetime(2024, 1, 1),
    catchup=False,
    tags=["saudi-sentinel", "dune-migration"],
) as dag:
