...
"""
Airflow DAG for the groundwater project.

Schedule: Annual peak-season (Mar)
Cron: 0 6 1 3 *
AOIs: aljouf-farms,hail-farms,tabuk-farms
...
with DAG(
    "groundwater_pipeline",
    default_args=default_args,
    schedule_interval="0 6 1 3 *",
    start_date=datetime(2024, 1, 1),
    catchup=False,
    tags=["saudi-sentinel", "groundwater"],
) as dag:
