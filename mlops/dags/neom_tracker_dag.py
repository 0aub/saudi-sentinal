...
"""
Airflow DAG for the neom-tracker project.

Schedule: Every 5 days (S1+S2)
Cron: 0 6 */5 * *
AOIs: neom-line
...
PROJECT = "neom-tracker"
MODEL_NAME = "neom-tracker-model"
...
with DAG(
    "neom_tracker_pipeline",
    default_args=default_args,
    schedule_interval="0 6 */5 * *",
    start_date=datetime(2024, 1, 1),
    catchup=False,
    tags=["saudi-sentinel", "neom-tracker"],
) as dag:
